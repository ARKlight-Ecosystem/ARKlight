...
mirror five different ways and rerunning it. Full suite 2595 passed (was
2320 on `0.06610`), plus one known failing assertion in
`test_js_vocabulary_v0067.py`, out of scope here. `0.06611` -> `0.06612`; out-of-band, no roadmap row, closes
